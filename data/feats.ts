...
// and 16 burdens (PG p. 151). Boons grant +1 to an ability via `abilityBonus`.
// Burdens grant +2 (or +1/+1 for Dark Blood) via `abilityBonus`, with three
// shapes: `fixed` (named ability), `choose-one` (player picks from a list or
// any ability), `choose-two` (player picks two distinct abilities). Bonuses
// flow through `computeFinalAbilities` alongside boon bonuses.
